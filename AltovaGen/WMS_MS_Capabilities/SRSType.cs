...
{
	public class SRSType : Altova.Xml.Node
	{
		...
		public SRSType() : base() { SetCollectionParents(); }

		public SRSType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public SRSType(XmlNode node) : base(node) { SetCollectionParents(); }
		public SRSType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public SRSType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "SRS");
		}
