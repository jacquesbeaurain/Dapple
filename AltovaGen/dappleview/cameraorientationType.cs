...
namespace dappleview
{
	public class cameraorientationType : Altova.Xml.Node
	{
		...
		public void Addlat(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "lat", newValue.ToString());
		}
		...
		public void Addlon(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "lon", newValue.ToString());
		}
		...
		public void Addheading(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "heading", newValue.ToString());
		}
		...
		public void Addtilt(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "tilt", newValue.ToString());
		}
		...
		public void Addaltitude(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "altitude", newValue.ToString());
		}
