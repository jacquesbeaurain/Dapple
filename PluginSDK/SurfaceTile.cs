...
namespace WorldWind
{
	...
	//	bool m_DeviceBindingMade = false;
			...
			WorldSurfaceRenderer parentWorldSurfaceRenderer)
		{
			...
			Point3d v = MathEngine.SphericalToCartesian(
         ...
         Point3d v0 = new Point3d(v.X, v.Y, v.Z);
         Point3d v1 = v0 * scale;
         ...
         Point3d v2 = new Point3d(v.X, v.Y, v.Z);
         Point3d v3 = v2 * scale;
         ...
         Point3d v4 = new Point3d(v.X, v.Y, v.Z);
         Point3d v5 = v4 * scale;
         ...
         Point3d v6 = new Point3d(v.X, v.Y, v.Z);
         Point3d v7 = v6 * scale;
		...
		private void buildTerrainMesh()
		{
			...
			for(int i = 0; i < thisVertexDensityElevatedPlus3; i++)
			{
				...
				for(int j = 0; j < thisVertexDensityElevatedPlus3; j++)
				{
                  ...
                  Point3d v = MathEngine.SphericalToCartesian(
						...
						m_DynamicTexture.nwVerts[base_idx].X = (float)v.X;
                  m_DynamicTexture.nwVerts[base_idx].Y = (float)v.Y;
                  m_DynamicTexture.nwVerts[base_idx].Z = (float)v.Z;
			...
			for(int i = 0; i < thisVertexDensityElevatedPlus3; i++)
			{
				...
				for(int j = 0; j < thisVertexDensityElevatedPlus3; j++)
				{
                  ...
                  m_DynamicTexture.neVerts[base_idx].X = (float)v.X;
                  m_DynamicTexture.neVerts[base_idx].Y = (float)v.Y;
                  m_DynamicTexture.neVerts[base_idx].Z = (float)v.Z;
			...
			for(int i = 0; i < thisVertexDensityElevatedPlus3; i++)
			{
				...
				for(int j = 0; j < thisVertexDensityElevatedPlus3; j++)
				{
                  ...
                  m_DynamicTexture.swVerts[base_idx].X = (float)v.X;
                  m_DynamicTexture.swVerts[base_idx].Y = (float)v.Y;
                  m_DynamicTexture.swVerts[base_idx].Z = (float)v.Z;
			...
			for(int i = 0; i < thisVertexDensityElevatedPlus3; i++)
			{
				...
				for(int j = 0; j < thisVertexDensityElevatedPlus3; j++)
				{
                  ...
                  m_DynamicTexture.seVerts[base_idx].X = (float)v.X;
                  m_DynamicTexture.seVerts[base_idx].Y = (float)v.Y;
                  m_DynamicTexture.seVerts[base_idx].Z = (float)v.Z;
