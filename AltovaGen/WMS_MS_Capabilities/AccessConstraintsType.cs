...
{
	public class AccessConstraintsType : Altova.Xml.Node
	{
		...
		public AccessConstraintsType() : base() { SetCollectionParents(); }

		public AccessConstraintsType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public AccessConstraintsType(XmlNode node) : base(node) { SetCollectionParents(); }
		public AccessConstraintsType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public AccessConstraintsType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "AccessConstraints");
		}
