...
namespace dappleview
{
	public class datasetType : Altova.Xml.Node
	{
		...
		public void Adduri(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "uri", newValue.ToString());
		}
		...
		public void Addinvisible(SchemaBoolean newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "invisible", newValue.ToString());
		}
