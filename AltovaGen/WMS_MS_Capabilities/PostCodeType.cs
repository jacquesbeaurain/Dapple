...
{
	public class PostCodeType : Altova.Xml.Node
	{
		...
		public PostCodeType() : base() { SetCollectionParents(); }

		public PostCodeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public PostCodeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public PostCodeType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public PostCodeType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "PostCode");
		}
