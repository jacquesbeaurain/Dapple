...
{
	public class TitleType : Altova.Xml.Node
	{
		...
		public TitleType() : base() { SetCollectionParents(); }

		public TitleType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public TitleType(XmlNode node) : base(node) { SetCollectionParents(); }
		public TitleType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public TitleType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Title");
		}
