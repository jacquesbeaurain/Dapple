//
// ContactElectronicMailAddressType.cs
//
...
{
	public class ContactElectronicMailAddressType : Altova.Xml.Node
	{
		...
		public ContactElectronicMailAddressType() : base() { SetCollectionParents(); }

		public ContactElectronicMailAddressType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ContactElectronicMailAddressType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ContactElectronicMailAddressType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ContactElectronicMailAddressType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ContactElectronicMailAddress");
		}
