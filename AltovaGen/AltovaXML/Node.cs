...
namespace Altova.Xml
{
	...
	public class FaultException : Exception
	{
		...
		public FaultException(Node n, string t)
		{
			node = n;
			thrower = t;
		}
	...
	public abstract class Node:IDisposable
	{
		...
		protected static bool DomElementNameEquals(XmlNode node, string URI, string name)
		{
		...
		public virtual void GenerateXsiTypeAttributes() {}
		public void SetXsiType(XmlNode node, string type)
		{
			XmlElement DOMElement = (XmlElement) node;
			XmlAttribute a = DOMElement.OwnerDocument.CreateAttribute("xsi:type", "http://www.w3.org/2001/XMLSchema-instance");
			a.Value = type;
