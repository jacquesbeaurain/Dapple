...
namespace dappleview
{
	public class tilelayerType : Altova.Xml.Node
	{
		...
		public tilelayerType() : base() { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "tilelayer");
		}
		...
		public XmlNode Adddataset(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Attribute, "", "dataset", newValue.ToString());
			return null;
		}
