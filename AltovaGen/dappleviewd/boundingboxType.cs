...
namespace dappleview
{
	public class boundingboxType : Altova.Xml.Node
	{
		...
		public void Addminlat(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "minlat", newValue.ToString());
		}
		...
		public void Addmaxlat(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "maxlat", newValue.ToString());
		}
		...
		public void Addminlon(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "minlon", newValue.ToString());
		}
		...
		public void Addmaxlon(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "maxlon", newValue.ToString());
		}
