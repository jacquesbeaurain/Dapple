...
namespace LayerSet
{
	public class Type_LongitudeCoordinate : Altova.Xml.Node
	{
		...
		public Type_LongitudeCoordinate(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		#endregion // Forward constructors

		public override void AdjustPrefix()
		{

		    for (	XmlNode DOMNode = GetDomFirstChild( NodeType.Element, "", "Value" );
					DOMNode != null; 
					DOMNode = GetDomNextChild( NodeType.Element, "", "Value", DOMNode )
				)
			{
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Type_LongitudeCoordinate");
		}


		#region Value2 Documentation
		public static string GetValue2AnnoDocumentation()
		{
			return "";		
		}
		public static string GetValue2Default()
		{
			return "";		
		}
		#endregion
		...
		public XmlNode AddValue2(ValueType2 newValue)
		{
