...
namespace WMS_MS_Capabilities
{
	public class ScaleHintType : Altova.Xml.Node
	{
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ScaleHint");
		}


		#region min Documentation
		public static string GetminAnnoDocumentation()
		{
			return "";		
		}
		public static string GetminDefault()
		{
			return "";		
		}
		#endregion
		...
		public XmlNode Addmin(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Attribute, "", "min", newValue.ToString());
			return null;
		}
		...
		#region max Documentation
		public static string GetmaxAnnoDocumentation()
		{
			return "";		
		}
		public static string GetmaxDefault()
		{
			return "";		
		}
		#endregion
		...
		public XmlNode Addmax(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Attribute, "", "max", newValue.ToString());
			return null;
		}
