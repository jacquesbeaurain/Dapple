...
{
	public class FormatType : Altova.Xml.Node
	{
		...
		public FormatType() : base() { SetCollectionParents(); }

		public FormatType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public FormatType(XmlNode node) : base(node) { SetCollectionParents(); }
		public FormatType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public FormatType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Format");
		}
