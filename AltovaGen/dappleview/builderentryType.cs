...
namespace dappleview
{
	public class builderentryType : Altova.Xml.Node
	{
		...
		{
			while (Hastileserverset())
				RemovetileserversetAt(0);
		}

		public void Addtileserverset(tileserversetType newValue)
		{
			AppendDomElement("", "tileserverset", newValue);
		}
		...
		{
			while (Hasvirtualearth())
				RemovevirtualearthAt(0);
		}

		public void Addvirtualearth(virtualearthType newValue)
		{
			AppendDomElement("", "virtualearth", newValue);
		}
