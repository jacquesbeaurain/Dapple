...
{
	public class FeesType : Altova.Xml.Node
	{
		...
		public FeesType() : base() { SetCollectionParents(); }

		public FeesType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public FeesType(XmlNode node) : base(node) { SetCollectionParents(); }
		public FeesType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public FeesType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Fees");
		}
