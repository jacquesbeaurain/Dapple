...
{
	public class AddressType : Altova.Xml.Node
	{
		...
		public AddressType() : base() { SetCollectionParents(); }

		public AddressType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public AddressType(XmlNode node) : base(node) { SetCollectionParents(); }
		public AddressType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public AddressType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Address");
		}
