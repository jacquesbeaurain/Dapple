...
{
	public class availablelayersType : Altova.Xml.Node
	{
		#region Forward constructors

		public availablelayersType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public availablelayersType(XmlNode node) : base(node) { SetCollectionParents(); }
		public availablelayersType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public availablelayersType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void Addtilelayer(tilelayerType newValue)
		{
			AppendDomElement("", "tilelayer", newValue);
		}
        ...
        {
            availablelayersType parent;
            public availablelayersType Parent
			{
				set
				{
					parent = value;
        ...
        public class tilelayerEnumerator: IEnumerator 
        {
			int nIndex;
			availablelayersType parent;
			public tilelayerEnumerator(availablelayersType par) 
			{
				parent = par;
				nIndex = -1;
			}
