...
namespace capabilities_1_3_0.wms
{
	 ...
	 */ 
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "wms:ContactInformation");
		}
 ...
 */ 
		...
		public XmlNode AddContactPosition(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "ContactPosition", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode AddContactFacsimileTelephone(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "ContactFacsimileTelephone", newValue.ToString());
			return null;
		}
