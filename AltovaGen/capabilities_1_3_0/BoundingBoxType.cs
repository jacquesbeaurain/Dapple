...
namespace capabilities_1_3_0.wms
{
	 ...
	 */ 
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "wms:BoundingBox");
		}
 ...
 */ 
		...
		public XmlNode AddCRS(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Attribute, "", "CRS", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode Addminx(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
 ...
 */ 
		...
		public XmlNode Addminy(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
 ...
 */ 
		...
		public XmlNode Addmaxx(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
 ...
 */ 
		...
		public XmlNode Addmaxy(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
 ...
 */ 
		...
		public XmlNode Addresx(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
