...
{
	public class ContactOrganizationType : Altova.Xml.Node
	{
		...
		public ContactOrganizationType() : base() { SetCollectionParents(); }

		public ContactOrganizationType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ContactOrganizationType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ContactOrganizationType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ContactOrganizationType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ContactOrganization");
		}
