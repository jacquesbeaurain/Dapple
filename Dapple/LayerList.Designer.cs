namespace Dapple
{
   partial class LayerList
   {
      ...
      private void InitializeComponent()
      {
			...
			this.cGoToButton.ToolTipText = "Go to";
			...
			this.cRemoveLayerButton.ToolTipText = "Remove data layers";
			...
			this.cExtractButton.ToolTipText = "Extract data layers...";
			...
			this.cExportButton.ToolTipText = "Create GeoTIFF snapshot...";
            ...
            this.cViewLegendToolStripMenuItem,
