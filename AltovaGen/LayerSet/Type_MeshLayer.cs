...
namespace LayerSet
{
	public class Type_MeshLayer : Altova.Xml.Node
	{
		...
		public Type_MeshLayer(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Type_MeshLayer");
		}
		...
		public DistanceAboveSurfaceType NewDistanceAboveSurface()
		{
			return new DistanceAboveSurfaceType();
		}
		...
		public ScaleFactorType NewScaleFactor()
		{
			return new ScaleFactorType();
		}
		...
		public MinViewRangeType NewMinViewRange()
		{
			return new MinViewRangeType();
		}
		...
		public XmlNode AddMinViewRange(MinViewRangeType newValue)
		{
			if( newValue.IsNull() == false )
		...
		public MaxViewRangeType NewMaxViewRange()
		{
			return new MaxViewRangeType();
		}
		...
		public XmlNode AddMaxViewRange(MaxViewRangeType newValue)
		{
			if( newValue.IsNull() == false )
		...
		public MeshFilePathType NewMeshFilePath()
		{
			return new MeshFilePathType();
		}
