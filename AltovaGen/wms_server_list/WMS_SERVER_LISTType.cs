...
namespace wms_server_list
{
	public class WMS_SERVER_LISTType : Altova.Xml.Node
	{
		...
		public WMS_SERVER_LISTType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		#endregion // Forward constructors

		public override void AdjustPrefix()
		{

		    for (	XmlNode DOMNode = GetDomFirstChild( NodeType.Element, "", "Server" );
					DOMNode != null; 
					DOMNode = GetDomNextChild( NodeType.Element, "", "Server", DOMNode )
				)
			{
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "WMS_SERVER_LIST");
		}


		#region Server Documentation
		public static string GetServerAnnoDocumentation()
		{
			return "";		
		}
		...
		public static int GetServerMinCount()
		{
			return 0;
		}

		public static int ServerMinCount
		{
			get
			{
				return 0;
		...
		public static int ServerMaxCount
		{
			get
			{
				return Int32.MaxValue;
		...
		public WMS_server NewServer()
		{
			return new WMS_server(domNode.OwnerDocument.CreateElement("Server", ""));
		}
		...
		public XmlNode GetStartingServerCursor()
		{
			return GetDomFirstChild( NodeType.Element, "", "Server" );
		}

		public XmlNode GetAdvancedServerCursor( XmlNode curNode )
		{
			return GetDomNextChild( NodeType.Element, "", "Server", curNode );
		}

		public WMS_server GetServerValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				  throw new Altova.Xml.XmlException("Out of range");
			else
				return new WMS_server( curNode );
		}
		...
		public XmlNode AddServer(WMS_server newValue)
		{
			return AppendDomElement("", "Server", newValue);
		}
