	...
	public class Constant
	{
		...
		public static string[] XmlVersion = new String[]
      {
		...
		public class Tag
		{
			...
			/// <summary></summary>
			public const string EXTRACT_FILE_TAG = "extract_file";
			...
			/// <summary></summary>
			public const string SERVER_LICENSE_TAG = "server_license";

			/// <summary></summary>
			public const string LICENSES_TAG = "licenses";

			/// <summary></summary>
			public const string LICENSE_TAG = "license";

			/// <summary></summary>
			public const string LIST_STYLESHEET_TAG = "list_stylesheets";
		...
		public class Attribute
		{
			...
			/// <summary></summary>
			public const string STYLESHEET_ATTR = "stylesheet";
