...
{
	public class AddressTypeType : Altova.Xml.Node
	{
		...
		public AddressTypeType() : base() { SetCollectionParents(); }

		public AddressTypeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public AddressTypeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public AddressTypeType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public AddressTypeType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "AddressType");
		}
