...
namespace capabilities_1_1_1
{
	public class ServiceType : Altova.Xml.Node
	{
		...
		public void AddFees(FeesType newValue)
		{
			AppendDomElement("", "Fees", newValue);
		}
		...
		public void AddAccessConstraints(AccessConstraintsType newValue)
		{
			AppendDomElement("", "AccessConstraints", newValue);
		}
