...
namespace WorldWind
{
	...
	public class MainApplication : System.Windows.Forms.Form, IGlobe
	{
		...
		private System.Windows.Forms.MenuItem menuItemPlaceFinder;
       ...
       private WorldWindSettingsComponent worldWindSettingsComponent1;
		...
		static void Main(string[] args)
		{
			try
         {
            ...
            app.worldWindow.WorldWindSettings.Save();
			}
		...
		public MainApplication()
		{
         ...
         //}
            ...
            //    try
            //    {
            //        WorldXmlDescriptor.WorldXmlDescriptorDoc curWorldXmlDescriptorDoc = new WorldXmlDescriptor.WorldXmlDescriptorDoc();
            //        WorldXmlDescriptor.WorldType curWorldRoot = new WorldXmlDescriptor.WorldType(curWorldXmlDescriptorDoc.Load(worldXmlDescriptorFile.FullName));
            //        if (!availableWorldList.Contains(curWorldRoot.Name.Value))
            //            this.availableWorldList.Add(curWorldRoot.Name.Value, curWorldRoot);

            //        System.Windows.Forms.MenuItem mi = new System.Windows.Forms.MenuItem(curWorldRoot.Name.Value, new System.EventHandler(OnWorldChange));
		...
		{
			// Use menu items as master settings, slaveanimatedEarthMananger toolbar button states
			//this.menuItemWMS.Checked = this.wmsBrowser!=null && this.wmsBrowser.Visible;
			//this.menuItemAnimatedEarth.Checked = this.!=null && this.animatedEarthMananger.Visible;
			//this.menuItemModisHotSpots.Checked = this.rapidFireModisManager!=null && this.rapidFireModisManager.Visible;
			//this.menuItemPlaceFinder.Checked = this.gotoDialog!=null && this.gotoDialog.Visible;
			//UpdateToolBarStates();
		...
		private void InitializeComponent()
		{
          ...
          this.menuItemPlaceFinder = new System.Windows.Forms.MenuItem();
          ...
          this.worldWindSettingsComponent1 = new WorldWind.WorldWindSettingsComponent(this.components);
          this.SuspendLayout();
          // 
          // worldWindow
          // 
          ...
          this.worldWindow.WorldWindSettingsComponent = this.worldWindSettingsComponent1;
          // 
          // mainMenu
          // 
          ...
          // menuItemPlaceFinder
          // 
          this.menuItemPlaceFinder.Index = 3;
          this.menuItemPlaceFinder.Text = "&Find Place\tCtrl+F";
          this.menuItemPlaceFinder.Click += new System.EventHandler(this.menuItemPlaceFinder_Click);
          // 
          // menuItemRefreshCurrentView
          // 
          this.menuItemRefreshCurrentView.Index = 4;
          ...
          // 
          // worldWindSettingsComponent1
          // 
          this.worldWindSettingsComponent1.CacheCleanupInterval = System.TimeSpan.Parse("01:00:00");
          this.worldWindSettingsComponent1.CacheCleanupIntervalXml = "PT1H";
          this.worldWindSettingsComponent1.CachePath = "C:\\Program Files (x86)\\Microsoft Visual Studio 8\\Common7\\IDE\\Cache";
          this.worldWindSettingsComponent1.CacheSizeMegaBytes = 1000;
          this.worldWindSettingsComponent1.ConfigPath = "C:\\Program Files (x86)\\Microsoft Visual Studio 8\\Common7\\IDE\\Config";
          this.worldWindSettingsComponent1.ConfigurationWizardAtStartup = true;
          this.worldWindSettingsComponent1.DataPath = "C:\\Program Files (x86)\\Microsoft Visual Studio 8\\Common7\\IDE\\Data";
          this.worldWindSettingsComponent1.DefaultWorld = "Earth";
          this.worldWindSettingsComponent1.FormatVersion = "8.0.50727.42";
          this.worldWindSettingsComponent1.ProxyPassword = "";
          this.worldWindSettingsComponent1.ProxyUrl = "";
          this.worldWindSettingsComponent1.ProxyUsername = "";
          this.worldWindSettingsComponent1.SettingsPath = "C:\\Documents and Settings\\Davidm\\Application Data\\NASA\\World Wind\\1.3.4\\WorldWind" +
              ".xml";
          this.worldWindSettingsComponent1.TotalRunTime = System.TimeSpan.Parse("00:56:55.3531416");
          this.worldWindSettingsComponent1.TotalRunTimeXml = "PT56M55.3531416S";
          this.worldWindSettingsComponent1.UseDynamicProxy = false;
          this.worldWindSettingsComponent1.UseWindowsDefaultProxy = true;
          // 
          // MainApplication
          // 
...
//         compiler.LoadStartupPlugins();
		...
		private void menuItemPlaceFinder_Click(object sender, System.EventArgs e)
		{
         //if(this.worldWindow.CurrentWorld == null)
         //   return;

         //World.Settings.ShowPlacenames = true;
         ...
         //   this.gotoDialog.Icon = this.Icon;
         //}
         //bool enabled = !this.menuItemPlaceFinder.Checked;
         //this.menuItemPlaceFinder.Checked = enabled;
         //this.gotoDialog.Visible = enabled;
         //this.gotoDialog.WindowState = FormWindowState.Normal;
			//UpdateToolBarStates();
		}
		...
		{
			//if(this.currentWorld == null || this.worldWindow == null)
				return;

			if(e.Button == this.toolBarButtonSearch)
			{
				menuItemPlaceFinder_Click(sender,e);
			}
			else if(e.Button == this.toolBarButtonPosition)
			{
		...
		private void toolBarHelp_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
		{
			...
			{
				BrowseTo("http://learn.arc.nasa.gov/worldwind");
			}
		...
		{
			BrowseTo("http://forum.worldwind.arc.nasa.gov/");
		}
		...
		{
			BrowseTo("http://www.worldwindcentral.com");
		}
      ...
      //   this.toolBarButtonSearch.Pushed = this.menuItemPlaceFinder.Checked;
      //}
      ...
      //   //if(this.gotoDialog != null)
      //   //   this.menuItemPlaceFinder.Checked = this.gotoDialog.Visible;
		...
		private void OpenStartupWorld()
      {
          ...
          //if (worldWindUri != null)
          //{
          //    foreach (WorldXmlDescriptor.WorldType worldType in this.availableWorldList.Values)
          //        if (string.Compare(worldWindUri.World, worldType.Name.Value, true, CultureInfo.InvariantCulture) == 0)
          //        {
          //            startupWorldName = worldType.Name.Value;
          //            break;
          //        }
          ...
          //}
			...
			if (startupWorldName == null)
				startupWorldName = this.worldWindow.WorldWindSettings.DefaultWorld;

        //if (startupWorldName == null)
        //{
        //    // Pick the first planet found in configuration
        //    foreach (WorldXmlDescriptor.WorldType worldType in this.availableWorldList.Values)
        //    {
        //        startupWorldName = worldType.Name.Value;
        //        break;
        ...
        //}
			...
			if (startupWorldName != null) 
			{
             ...
             //       startupWorldName,
             //       Settings.ConfigPath));
             this.OpenWorld();//worldDescriptor );
			}
		...
		/// Loads a new planet
		/// </summary>
		private void OpenWorld()//WorldXmlDescriptor.WorldType worldDescriptor)
		{
        // if(this.worldWindow.CurrentWorld != null)
        // {
        //    try
        ...
        //}
         ...
         //}
          ...
          //}
        //this.currentWorld = worldDescriptor;
          ...
          TerrainAccessor terrainAccessor = new NltTerrainAccessor("Earth", -180, -90, 180, 90,
              new TerrainTileService("http://worldwind25.arc.nasa.gov/tile/tile.aspx",
              "100", 20, 150, "bil", 8, "C:\\DaveSource\\w\\worldwind\\dev\\WorldWind\\bin\\Debug\\Cache\\Earth\\TerrainAccessor\\SRTM"), null);

          World world = new World("Earth",
             new Microsoft.DirectX.Vector3(0, 0, 0), new Microsoft.DirectX.Quaternion(0, 0, 0, 0),
             (float)6378137,
             Path.Combine(worldWindow.Cache.CacheDirectory, "Earth"),
             terrainAccessor);

          this.worldWindow.CurrentWorld = world;

          NASA.Plugins.BmngLoader bmng = new NASA.Plugins.BmngLoader(@"C:\DaveSource\w\worldwind\dev\WorldWind\bin\Debug");
          Atmosphere.Plugin.Atmosphere atmo = new Atmosphere.Plugin.Atmosphere(@"C:\DaveSource\w\worldwind\dev\WorldWind\bin\Debug");
          Stars3D.Plugin.Stars3D stars = new Stars3D.Plugin.Stars3D(@"C:\DaveSource\w\worldwind\dev\WorldWind\bin\Debug");
          GeosoftPlugin.GeosoftPlugin g = new GeosoftPlugin.GeosoftPlugin(this.worldWindow);
          CMPlugins.OverviewForm.OverviewFormLoader oloader = new WorldWind.CMPlugins.OverviewForm.OverviewFormLoader( @"C:\DaveSource\w\worldwind\dev\WorldWind\bin\Debug\Data\Earth\BmngBathy\world.topo.bathy.200407.jpg", this.worldWindow);

          this.worldWindow.AddPlugin( bmng);
          this.worldWindow.AddPlugin(atmo);
          this.worldWindow.AddPlugin(stars);
          this.worldWindow.AddPlugin(g);
          this.worldWindow.AddPlugin(oloader);
          oloader.ShowForm();
         ...
         //this.menuItemModisHotSpots.Enabled = world.IsEarth;
         //this.menuItemAnimatedEarth.Enabled = world.IsEarth;
      ...
      //}
       ...
       //           Path.Combine(Path.Combine(currentWorld.Name.Value, "TerrainAccessor"), curTerrainAccessorType.Name.Value)));
			...
			if (e.Alt)
			{
				...
				switch(e.KeyCode)
				{
					case Keys.A:
						...
						return true;
					case Keys.Q:
						using( PropertyBrowserForm worldWindSettings = new PropertyBrowserForm( this.worldWindow.WorldWindSettings, "World Wind Settings" ) )
						{
			...
			else if (e.Control)
			{
				...
				switch(e.KeyCode)
				{
					...
					case Keys.Insert:
						...
						return true;
					case Keys.F:
						menuItemPlaceFinder_Click(this, e);
						return true;
					case Keys.H:
			...
			else
			{
				...
				switch(e.KeyCode)
				{
					...
					case Keys.F5:
						...
						return true;
					case Keys.F6:
						this.menuItemPlaceFinder_Click(this,e);
						return true;
					case Keys.F7:
