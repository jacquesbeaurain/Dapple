//
// ContactFacsimileTelephoneType.cs
//
...
{
	public class ContactFacsimileTelephoneType : Altova.Xml.Node
	{
		...
		public ContactFacsimileTelephoneType() : base() { SetCollectionParents(); }

		public ContactFacsimileTelephoneType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ContactFacsimileTelephoneType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ContactFacsimileTelephoneType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ContactFacsimileTelephoneType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ContactFacsimileTelephone");
		}
