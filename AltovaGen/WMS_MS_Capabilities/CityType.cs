...
{
	public class CityType : Altova.Xml.Node
	{
		...
		public CityType() : base() { SetCollectionParents(); }

		public CityType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CityType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CityType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CityType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "City");
		}
