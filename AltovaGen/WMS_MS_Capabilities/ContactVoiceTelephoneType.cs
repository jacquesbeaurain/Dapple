...
{
	public class ContactVoiceTelephoneType : Altova.Xml.Node
	{
		...
		public ContactVoiceTelephoneType() : base() { SetCollectionParents(); }

		public ContactVoiceTelephoneType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ContactVoiceTelephoneType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ContactVoiceTelephoneType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ContactVoiceTelephoneType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ContactVoiceTelephone");
		}
