...
namespace Geosoft.Dap
{
	...
	public class Configuration
	{
		...
		public string GetDescription()
		{
			...
			{
				oAttr = oAttrNode.Attributes.GetNamedItem(Geosoft.Dap.Xml.Common.Constant.Attribute.NAME_ATTR);
				if (oAttr == null || oAttr.Value != "Purpose") continue;
		...
		/// <summary>
		/// Get the name of the server's administrator
		/// </summary>
		/// <returns></returns>
		public string GetAdministratorName()
		{
			...
			{
				oAttr = oAttrNode.Attributes.GetNamedItem(Geosoft.Dap.Xml.Common.Constant.Attribute.NAME_ATTR);
				if (oAttr == null || oAttr.Value != "Administrator") continue;
		...
		/// <summary>
		/// Get the phone number of the server's administrator
		/// </summary>
		/// <returns></returns>
		public string GetAdministratorPhone()
		{
			...
			{
				oAttr = oAttrNode.Attributes.GetNamedItem(Geosoft.Dap.Xml.Common.Constant.Attribute.NAME_ATTR);
				if (oAttr == null || oAttr.Value != "Phone") continue;
		...
		/// <summary>
		/// Get the email of the server's administrator
		/// </summary>
		/// <returns></returns>
		public string GetAdministratorEMail()
		{
			...
			{
				oAttr = oAttrNode.Attributes.GetNamedItem(Geosoft.Dap.Xml.Common.Constant.Attribute.NAME_ATTR);
				if (oAttr == null || oAttr.Value != "EMail") continue;
