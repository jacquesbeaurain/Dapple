...
namespace dappleview
{
	public class builderdirectoryType : builderdirectoryBaseType
	{
		...
		{
			while (Hasspecialcontainer())
				RemovespecialcontainerAt(0);
		}

		public void Addspecialcontainer(SpecialDirectoryType newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "specialcontainer", newValue.ToString());
		}
		...
		public void Addbuilderentry(builderentryType newValue)
		{
			AppendDomElement("", "builderentry", newValue);
		}
