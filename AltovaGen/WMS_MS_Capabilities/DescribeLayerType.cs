...
namespace WMS_MS_Capabilities
{
	public class DescribeLayerType : Altova.Xml.Node
	{
		...
		public DescribeLayerType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "DescribeLayer");
		}
