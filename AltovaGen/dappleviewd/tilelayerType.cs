...
namespace dappleview
{
	public class tilelayerType : Altova.Xml.Node
	{
		...
		public override void AdjustPrefix()
		{
		    ...
		    for (	XmlNode DOMNode = GetDomFirstChild( NodeType.Attribute, "", "serverlogopath" );
					DOMNode != null; 
					DOMNode = GetDomNextChild( NodeType.Attribute, "", "serverlogopath", DOMNode )
				)
			{
				InternalAdjustPrefix(DOMNode, false);
			}
		...
		#region serverlogopath accessor methods
		public static int GetserverlogopathMinCount()
		{
			return 0;
		}

		public static int serverlogopathMinCount
		{
			get
			{
				return 0;
		...
		public static int GetserverlogopathMaxCount()
		{
			return 1;
		}

		public static int serverlogopathMaxCount
		{
			get
			{
				return 1;
		...
		public int GetserverlogopathCount()
		{
			return DomChildCount(NodeType.Attribute, "", "serverlogopath");
		}

		public int serverlogopathCount
		{
			get
			{
				return DomChildCount(NodeType.Attribute, "", "serverlogopath");
		...
		public bool Hasserverlogopath()
		{
			return HasDomChild(NodeType.Attribute, "", "serverlogopath");
		}

		public SchemaString Newserverlogopath()
		{
			return new SchemaString();
		}

		public SchemaString GetserverlogopathAt(int index)
		{
			return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "serverlogopath", index)));
		}

		public XmlNode GetStartingserverlogopathCursor()
		{
			return GetDomFirstChild( NodeType.Attribute, "", "serverlogopath" );
		}

		public XmlNode GetAdvancedserverlogopathCursor( XmlNode curNode )
		{
			return GetDomNextChild( NodeType.Attribute, "", "serverlogopath", curNode );
		}

		public SchemaString GetserverlogopathValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				  throw new Altova.Xml.XmlException("Out of range");
			else
		...
		public SchemaString Getserverlogopath()
		{
			return GetserverlogopathAt(0);
		}

		public SchemaString serverlogopath
		{
			get
			{
				return GetserverlogopathAt(0);
		...
		public void RemoveserverlogopathAt(int index)
		{
			RemoveDomChildAt(NodeType.Attribute, "", "serverlogopath", index);
		}

		public void Removeserverlogopath()
		{
			while (Hasserverlogopath())
				RemoveserverlogopathAt(0);
		}

		public void Addserverlogopath(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "serverlogopath", newValue.ToString());
		}

		public void InsertserverlogopathAt(SchemaString newValue, int index)
		{
			if( newValue.IsNull() == false )
				InsertDomChildAt(NodeType.Attribute, "", "serverlogopath", index, newValue.ToString());
		}

		public void ReplaceserverlogopathAt(SchemaString newValue, int index)
		{
			ReplaceDomChildAt(NodeType.Attribute, "", "serverlogopath", index, newValue.ToString());
		}
		#endregion // serverlogopath accessor methods

		#region serverlogopath collection
        public serverlogopathCollection	Myserverlogopaths = new serverlogopathCollection( );

        public class serverlogopathCollection: IEnumerable
        {
            tilelayerType parent;
            public tilelayerType Parent
			{
			...
			public serverlogopathEnumerator GetEnumerator() 
			{
				return new serverlogopathEnumerator(parent);
			}
        ...
        public class serverlogopathEnumerator: IEnumerator 
        {
			int nIndex;
			tilelayerType parent;
			public serverlogopathEnumerator(tilelayerType par) 
			{
				parent = par;
				nIndex = -1;
			}
			...
			{
				nIndex++;
				return(nIndex < parent.serverlogopathCount );
			}
			public SchemaString  Current 
			{
				get 
				{
					return(parent.GetserverlogopathAt(nIndex));
				}
			}
			object IEnumerator.Current 
			{
        ...
        #endregion // serverlogopath collection
		...
		{
			return new SchemaDouble(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "distanceabovesurface", index)));
		}
		...
		public void Adddistanceabovesurface(SchemaDouble newValue)
		{
			if( newValue.IsNull() == false )
