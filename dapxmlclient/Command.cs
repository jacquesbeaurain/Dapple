...
namespace Geosoft.Dap
{
	...
	public class Command
	{
		...
		/// <param name="strPassword"></param>
		/// <returns>The configuration response in GeosoftXML</returns>
		public System.Xml.XmlDocument GetServerLicense(string strPassword)
		{
			return GetServerLicense(strPassword, null);
		}
		...
		/// <param name="oLicenses"></param>
		/// <returns>The configuration response in GeosoftXML</returns>
		public void GetServerLicense(string strPassword, out string strVersion, out System.Collections.Generic.List<string> oLicenses)
		{
			System.Xml.XmlDocument oDoc;
			System.Xml.XmlReader oReader;
			System.IO.StringReader oStringReader;

			oLicenses = new System.Collections.Generic.List<string>();
			strVersion = string.Empty;

			oDoc = GetServerLicense(strPassword, null);

			oStringReader = new System.IO.StringReader(oDoc.OuterXml);
			oReader = System.Xml.XmlReader.Create(oStringReader);

			if (oReader.ReadToFollowing(Constant.Tag.LICENSES_TAG))
			{
				strVersion = oReader.GetAttribute(Constant.Attribute.VERSION_ATTR);
			}


			while (oReader.ReadToFollowing(Constant.Tag.LICENSE_TAG))
			{
				string strLicense = oReader.GetAttribute(Constant.Attribute.NAME_ATTR);
				if (!string.IsNullOrEmpty(strLicense))
					oLicenses.Add(strLicense);
			}
			oReader.Close();
			oStringReader.Close();
		}
		...
		/// <param name="progressCallBack"></param>
		/// <returns>The configuration response in GeosoftXML</returns>
		public System.Xml.XmlDocument GetServerLicense(string strPassword, UpdateProgessCallback progressCallBack)
		{
			string szUrl;
			System.Xml.XmlDocument hRequestDocument;
			System.Xml.XmlDocument hResponseDocument;
			...
			try
			{
				...
				szUrl = CreateUrl(Constant.Request.CONFIGURATION);
				hRequestDocument = m_hEncodeRequest.ServerLicense(null, strPassword);
				hResponseDocument = m_oCommunication.Send(szUrl, hRequestDocument, progressCallBack);
			}
			finally
			{
		...
		/// <summary>
		/// Cancel the extract request
		/// </summary>
		/// <param name="szKey">The extraction key</param>
		/// <returns>The extact data response in GeosoftXML</returns>
		public System.Xml.XmlDocument ExtractCancel(string szKey)
		{
			return ExtractCancel(szKey, null);
		}
		...
		/// <param name="progressCallBack">Progress handler (may be null)</param>
		/// <returns>The extract progress response in GeosoftXML</returns>
		public System.Xml.XmlDocument ExtractCancel(string szKey, UpdateProgessCallback progressCallBack)
		{
			string szUrl;
			System.Xml.XmlDocument hRequestDocument;
			System.Xml.XmlDocument hResponseDocument;
			...
			try
			{
				...
				hRequestDocument = m_hEncodeRequest.ExtractCancel(null, szKey);
				hResponseDocument = m_oCommunication.Send(szUrl, hRequestDocument, progressCallBack);
			}
			finally
			{
		...
		/// <summary>
		/// Get the file name of the extracted dataset. You must already have a mapping to this path
		/// </summary>
		/// <param name="szKey">The extraction key</param>
		/// <returns>The extact data response in GeosoftXML</returns>
		public System.Xml.XmlDocument ExtractFileName(string szKey)
		{
			return ExtractFileName(szKey, null);
		}
		...
		/// <returns>The extact data response in GeosoftXML</returns>
		public void ExtractFileName(string szKey, out string strFileName)
		{
			System.Xml.XmlDocument oDoc = ExtractFileName(szKey, null);
			m_hParse.ExtractFileName(oDoc, out strFileName);
		}
		...
		/// <param name="progressCallBack">Progress handler (may be null)</param>
		/// <returns>The extact data response in GeosoftXML</returns>
		public System.Xml.XmlDocument ExtractFileName(string szKey, UpdateProgessCallback progressCallBack)
		{
			string szUrl;
			System.Xml.XmlDocument hRequestDocument;
			System.Xml.XmlDocument hResponseDocument;
			...
			try
			{
				...
				hRequestDocument = m_hEncodeRequest.ExtractFileName(null, szKey);
				hResponseDocument = m_oCommunication.Send(szUrl, hRequestDocument, progressCallBack);
			}
			finally
			{
		...
		/// </summary>
		/// <returns>The configuration response in GeosoftXML</returns>
		public System.Xml.XmlDocument ListStylesheets()
		{
			return ListStylesheets(null);
		}
		...
		/// <returns>The configuration response in GeosoftXML</returns>
		public void ListStylesheets(out System.Collections.Generic.SortedList<string, string> oStylesheets)
		{
			ListStylesheets(out oStylesheets, null);			
		}
		...
		/// <param name="progressCallBack">Progress handler (may be null)</param>
		/// <returns>The configuration response in GeosoftXML</returns>
		public System.Xml.XmlDocument GetStylesheet(string strName, UpdateProgessCallback progressCallBack)
		{
			string szUrl;
			System.Xml.XmlDocument hRequestDocument;
			System.Xml.XmlDocument hResponseDocument;
			...
			try
			{
				...
				szUrl = CreateUrl(Constant.Request.GET_STYLESHEET);
				hRequestDocument = m_hEncodeRequest.GetStylesheet(null, strName);
				hResponseDocument = m_oCommunication.Send(szUrl, hRequestDocument, progressCallBack);
			}
			finally
			{
