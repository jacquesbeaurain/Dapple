...
{
	public class ContactPersonType : Altova.Xml.Node
	{
		...
		public ContactPersonType() : base() { SetCollectionParents(); }

		public ContactPersonType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ContactPersonType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ContactPersonType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ContactPersonType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ContactPerson");
		}
