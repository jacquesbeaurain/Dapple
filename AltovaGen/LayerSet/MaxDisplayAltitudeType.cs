...
namespace LayerSet
{
	...
	public class MaxDisplayAltitudeType : SchemaDouble
	{
		...
		public MaxDisplayAltitudeType(SchemaDouble newValue) : base(newValue)
		{
			Validate();
		}
		...
		public  void Validate()
		{
			...
			if (CompareTo(GetMinInclusive()) < 0)
				throw new System.Exception("Value of MaxDisplayAltitude is out of range.");
		}
