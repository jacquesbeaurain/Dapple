...
{
	public class AbstractType : Altova.Xml.Node
	{
		...
		public AbstractType() : base() { SetCollectionParents(); }

		public AbstractType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public AbstractType(XmlNode node) : base(node) { SetCollectionParents(); }
		public AbstractType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public AbstractType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "Abstract");
		}
