...
namespace capabilities_1_3_0.wms
{
	 ...
	 */ 
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "wms:ContactAddress");
		}
 ...
 */ 
		...
		public XmlNode AddAddressType(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "AddressType", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode AddAddress(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "Address", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode AddCity(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "City", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode AddStateOrProvince(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "StateOrProvince", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode AddPostCode(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "PostCode", newValue.ToString());
			return null;
		}
 ...
 */ 
		...
		public XmlNode AddCountry(SchemaString newValue)
		{
			if( newValue.IsNull() == false )
				return AppendDomChild(NodeType.Element, "http://www.opengis.net/wms", "Country", newValue.ToString());
			return null;
		}
